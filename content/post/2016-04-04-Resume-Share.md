...
- Driving conversations between engineering, business/product teams. Coordinating end to end data and analytics planning to execution efforts between teams.
- Contributing to Capital One Retail Bank's overall ML stack. Research and evaluate external and internal DS/ML toolings.
